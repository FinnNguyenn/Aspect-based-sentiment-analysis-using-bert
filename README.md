...
The model is trained and evaluated on the widely recognized **SemEval 2014 Task 4** benchmark, focusing on user reviews in the **Restaurant** and **Laptop** domains.
